...
const Frontselfie = () => {
  ...
  const pickImage = async () => {
    ...
    if (!result.canceled) {
      ...
      await AsyncStorage.setItem('frontSelfie', fileUri);
    }
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.topContainer}>
        <Text style={styles.timeText}>Upload Front Selfie</Text>
      </View>
      <View style={styles.imageContainer}>
        {image ? (
          ...
          <ImageBackground
            source={require('../../assets/faceimage/frontselfie.jpg')}
            style={styles.image}
          >
